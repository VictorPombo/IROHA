...
const MENU_ITEMS: Record<string, MenuItem[]> = {
  Entradas: [
    ...
    { name: "Harumaki", desc: "Rolinho primavera com recheio de queijo", price: "R$ 29,90", image: "/images/tempura.png" },
    { name: "Shimeji", desc: "Cogumelos pequenos na manteiga e shoyu", price: "R$ 49,90", image: "/images/yakisoba.png", badge: "Mais Pedido" },
    { name: "Shimeji com Lula", desc: "Cogumelos pequenos com anéis de lula", price: "R$ 45,90", image: "/images/teppanyaki.png" },
  ...
  Sushi: [
    ...
    { name: "Sushi Salmão (16 un.)", desc: "8 sushis, 6 salmonmakis e 2 jhous", price: "R$ 45,90", image: "/images/salmon-sashimi.png", badge: "Mais Pedido" },
    { name: "Sushi Atum (16 un.)", desc: "8 sushis e 6 tekkas", price: "R$ 45,90", image: "/images/tuna-sashimi.png" },
    ...
    { name: "Sushi Jhou (8 un.)", desc: "Sushi de salmão picadinho com cebolinha e maionese", price: "R$ 45,90", image: "/images/real/destaque-combo.png" },
    { name: "Sushi Skin (10 un.)", desc: "6 sushis e 4 uramaki skin", price: "R$ 45,90", image: "/images/temaki-premium.png" },
  ],
  Duplas: [
    { name: "Dupla Kani", desc: "Dupla de nigiri de Kani", price: "R$ 8,00", image: "/images/hot-roll.png" },
    { name: "Dupla Salmão", desc: "Dupla de nigiri de Salmão fresco", price: "R$ 8,00", image: "/images/nigiri.png", badge: "Mais Pedido" },
    { name: "Dupla Peixe Branco", desc: "Dupla de nigiri de Peixe Branco", price: "R$ 7,50", image: "/images/hero-sushi.png" },
    { name: "Dupla Atum", desc: "Dupla de nigiri de Atum", price: "R$ 9,00", image: "/images/tuna-sashimi.png" },
  ...
  Makisushis: [
    ...
    { name: "Uramaki Salmão", desc: "8 unidades", price: "R$ 45,90", image: "/images/salmon-sashimi.png", badge: "Favorito" },
    { name: "Uramaki Skin", desc: "8 unidades", price: "R$ 45,90", image: "/images/real/real-7.jpg" },
    ...
    { name: "Tekkamaki", desc: "8 unidades", price: "R$ 45,90", image: "/images/tuna-sashimi.png" },
    { name: "Salmonmaki", desc: "8 unidades", price: "R$ 45,90", image: "/images/nigiri.png" },
    { name: "Ebiten Uramaki", desc: "8 unidades", price: "R$ 45,90", image: "/images/tempura.png" },
  ...
  Sashimi: [
    { name: "Sashimi Simples (16 fatias)", desc: "Atum, salmão e peixe branco", price: "R$ 59,90", image: "/images/hero-sushi.png" },
    ...
    { name: "Sashimi de Atum (16 fatias)", desc: "Atum fresco fatiado", price: "R$ 59,90", image: "/images/tuna-sashimi.png" },
  ...
  "Pratos Quentes": [
    { name: "Yakisoba Misto", desc: "Macarrão, carne bovina, frango e legumes", price: "R$ 49,90", image: "/images/yakisoba.png", badge: "Favorito" },
    { name: "Yakisoba de Carne", desc: "Macarrão, carne bovina e legumes", price: "R$ 64,90", image: "/images/teppanyaki.png" },
    ...
    { name: "Yakisoba Camarão", desc: "Macarrão, camarão e legumes", price: "R$ 64,90", image: "/images/tempura.png" },
  ...
  Teppanyaki: [
    ...
    { name: "Teppan de Salmão", desc: "Grelhado com legumes, arroz e missoshiru", price: "R$ 69,90", image: "/images/teppanyaki.png", badge: "Destaque" },
    { name: "Teppan de Lula", desc: "Grelhado com legumes, arroz e missoshiru", price: "R$ 59,90", image: "/images/real/real-4.jpg" },
    { name: "Teppan Frutos do Mar", desc: "Grelhado com legumes, arroz e missoshiru", price: "R$ 69,90", image: "/images/yakisoba.png" },
    { name: "Teppan de Camarão", desc: "Grelhado com legumes, arroz e missoshiru", price: "R$ 69,90", image: "/images/tempura.png" },
  ...
  Tempurá: [
    ...
    { name: "Tempurá de Camarão", desc: "12 camarões empanados", price: "R$ 55,90", image: "/images/tempura.png", badge: "Especial" },
    { name: "Tempurá Misto", desc: "6 camarões e legumes mistos", price: "R$ 49,90", image: "/images/yakisoba.png" },
  ],
  Temaki: [
    { name: "Temaki Salmão", desc: "Enrolado em forma de cone - 1 unidade", price: "R$ 39,90", image: "/images/temaki-premium.png", badge: "Favorito" },
    { name: "Temaki Atum", desc: "Enrolado em forma de cone - 1 unidade", price: "R$ 39,90", image: "/images/tuna-sashimi.png" },
    ...
    { name: "Temaki Filadelfia", desc: "Enrolado em forma de cone - 1 unidade", price: "R$ 39,90", image: "/images/salmon-sashimi.png", badge: "Mais Pedido" },
    { name: "Temaki Shimeji", desc: "Enrolado em forma de cone - 1 unidade", price: "R$ 39,90", image: "/images/yakisoba.png" },
    { name: "Temaki Camarão", desc: "Enrolado em forma de cone - 1 unidade", price: "R$ 39,90", image: "/images/tempura.png" },
  ],
};
